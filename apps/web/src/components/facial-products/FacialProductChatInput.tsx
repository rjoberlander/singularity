...
interface FacialProductChatInputProps {
  onSubmit: (data: { text?: string; file?: File; url?: string }) => void;
  isProcessing?: boolean;
}

export function FacialProductChatInput({ onSubmit, isProcessing }: FacialProductChatInputProps) {
      ...
      {isDragging ? (
        ...
        <>
          ...
          <div className="space-y-1">
            <Textarea
              data-testid="facial-product-chat-input"
              value={text}
              onChange={(e) => setText(e.target.value.slice(0, MAX_TEXT_LENGTH))}
              onKeyDown={handleKeyDown}
              onPaste={handlePaste}
              placeholder="Paste skincare routine or product list for AI extraction..."
          ...
          <div className="flex flex-col gap-2">
            ...
            <Button
              data-testid="facial-product-send-button"
              size="sm"
              className="w-full h-8 text-xs"
