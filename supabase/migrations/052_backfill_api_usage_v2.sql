-- BACKFILL HISTORICAL API USAGE v2
-- Uses is_google_sourced OR google_photo_reference to find Google photos

-- 1. Count photos from Google (using either indicator)
...
WHERE (m.google_photo_reference IS NOT NULL OR m.is_google_sourced = true)
